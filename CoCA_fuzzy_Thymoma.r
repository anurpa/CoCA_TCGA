#Pavana Anur
#CoCA for thymoma
#https://www.cell.com/cancer-cell/fulltext/S1535-6108(18)30003-5 
#Figure 3 
...
#sampleorder is file with TCGA ID's in require order
sampleorder=read.table("sample_order.txt",header=F)
annotord=annot[c(sampleorder),]
